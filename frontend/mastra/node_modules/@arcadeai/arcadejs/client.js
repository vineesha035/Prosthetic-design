...
var _Arcade_instances, _a, _Arcade_encoder, _Arcade_baseURLOverridden;
...
class Arcade {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('ARCADE_BASE_URL'), apiKey = (0, env_1.readEnv)('ARCADE_API_KEY'), ...opts } = {}) {
        _Arcade_instances.add(this);
        _Arcade_encoder.set(this, void 0);
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('ARCADE_LOG'), "process.env['ARCADE_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Arcade_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Arcade_instances, "m", _Arcade_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Arcade_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Arcade = Arcade;
_a = Arcade, _Arcade_encoder = new WeakMap(), _Arcade_instances = new WeakSet(), _Arcade_baseURLOverridden = function _Arcade_baseURLOverridden() {
