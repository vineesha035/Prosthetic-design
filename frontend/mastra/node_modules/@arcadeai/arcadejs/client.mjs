...
export class Arcade {
     ...
     */
    constructor({ baseURL = readEnv('ARCADE_BASE_URL'), apiKey = readEnv('ARCADE_API_KEY'), ...opts } = {}) {
        ...
        __classPrivateFieldSet(this, _Arcade_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!__classPrivateFieldGet(this, _Arcade_instances, "m", _Arcade_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return __classPrivateFieldGet(this, _Arcade_encoder, "f").call(this, { body, headers });
        }
    }
}
