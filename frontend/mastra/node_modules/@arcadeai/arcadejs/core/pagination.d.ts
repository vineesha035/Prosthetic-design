...
export declare class PagePromise<PageClass extends AbstractPage<Item>, Item = ReturnType<PageClass['getPaginatedItems']>[number]> extends APIPromise<PageClass> implements AsyncIterable<Item> {
    constructor(client: Arcade, request: Promise<APIResponseProps>, Page: new (...args: ConstructorParameters<typeof AbstractPage>) => PageClass);
    /**
...
export declare class OffsetPage<Item> extends AbstractPage<Item> implements OffsetPageResponse<Item> {
    ...
    total_count: number;
    offset: number;
    constructor(client: Arcade, response: Response, body: OffsetPageResponse<Item>, options: FinalRequestOptions);
