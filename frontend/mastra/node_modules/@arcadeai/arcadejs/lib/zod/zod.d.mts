import { ExecuteToolResponse, ToolDefinition } from "../../resources/tools/tools.mjs";
import { ZodTool, ZodToolSchema, ToolExecuteFunctionFactoryInput, CreateZodToolInput, CreateMultipleZodToolsInput, ToolExecuteFunction, ToolAuthorizationResponse } from "./types.mjs";
import { z } from 'zod';
/**
 ...
 */
export declare function convertParametersToZodSchema(parameters: ToolDefinition.Input): z.ZodObject<z.ZodRawShape>;
/**
