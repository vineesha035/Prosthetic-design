...
export declare class Auth extends APIResource {
     ...
     * ```
     */
    start(userId: string, provider: string, options?: AuthStartOptions): APIPromise<Shared.AuthorizationResponse>;
    /**
...
export declare namespace Auth {
    export { type AuthRequest as AuthRequest, type ConfirmUserRequest as ConfirmUserRequest, type ConfirmUserResponse as ConfirmUserResponse, type AuthAuthorizeParams as AuthAuthorizeParams, type AuthConfirmUserParams as AuthConfirmUserParams, type AuthStatusParams as AuthStatusParams, type AuthStartOptions as AuthStartOptions, };
}
