...
export declare class Workers extends APIResource {
     ...
     */
    list(query?: WorkerListParams | null | undefined, options?: RequestOptions): PagePromise<WorkerResponsesOffsetPage, WorkerResponse>;
    /**
     * Delete a worker
     */
     ...
     */
    tools(id: string, query?: WorkerToolsParams | null | undefined, options?: RequestOptions): PagePromise<ToolDefinitionsOffsetPage, ToolsAPI.ToolDefinition>;
}
