...
export declare const ErrorCodeExtendedAgentCardNotConfigured = -32007;
...
export declare const ErrorCodeExtensionSupportRequired = -32008;
...
export declare const ErrorCodeVersionNotSupported = -32009;
