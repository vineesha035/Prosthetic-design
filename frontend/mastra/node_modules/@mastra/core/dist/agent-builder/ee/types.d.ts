import type { Provider, ModelForProvider } from '../../llm/model/index.js';
import type { SerializedMemoryConfig } from '../../memory/types.js';
import type { StorageBrowserRef, StorageWorkspaceRef } from '../../storage/types.js';
/**
 ...
 */
export declare const BUILDER_FEATURE_DEFAULTS: Required<Omit<AgentFeatures, 'browser'>>;
/**
 ...
 */
export declare function resolveAgentFeatures(raw: AgentFeatures | undefined, ctx: ResolveAgentFeaturesContext): Required<AgentFeatures>;
/**
