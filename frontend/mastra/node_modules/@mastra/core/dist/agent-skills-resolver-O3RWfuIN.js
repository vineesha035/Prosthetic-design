import { n as LocalSkillSource, r as validateSkillMetadata, t as WorkspaceSkillsImpl } from "./workspace-skills-BcLsoENh.js";
...
function resolveAgentSkills(skills) {
	...
	if (inlineSkills.length > 0 && pathSkills.length > 0) {
		source = new CompositeSkillSource(new LocalSkillSource(), new InlineSkillSource(inlineSkills));
		...
		for (const skill of inlineSkills) skillPaths.push(`inline/${skill.name}`);
	} else source = new LocalSkillSource();
...
//#endregion
export { isInlineSkill as a, createSkill as i, resolveAgentSkills as n, InlineSkillSource as r, mergeWorkspaceSkills as t };

//# sourceMappingURL=agent-skills-resolver-O3RWfuIN.js.map