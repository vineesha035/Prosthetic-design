import { gt as ProviderHistoryCompat, mt as isBadRequestError, pt as StreamErrorRetryProcessor, t as Agent, yt as PrefillErrorHandler } from "../agent-Dj30gJa3.js";
import { v as DEFAULT_GOAL_JUDGE_PROMPT } from "../task-state-processor-C9agcUfw.js";
import { G as LocalFilesystem, k as LocalSandbox, x as Workspace } from "../workspace-CvZ9jmZN.js";
import { t as TaskSignalProvider } from "../signals-CrlfiLDz.js";
//#region src/coding-agent/prompt.ts
...
//#endregion
//#region src/coding-agent/index.ts
/**
...
const ECONNRESET_RETRY_INITIAL_DELAY_MS = 1e3;
const ECONNRESET_RETRY_MAX_DELAY_MS = 3e4;
...
function createCodingAgent(config) {
	...
	const resolvedGoal = goal ? {
		...goal,
		prompt: goal.prompt ?? DEFAULT_GOAL_JUDGE_PROMPT
	} : void 0;
	return new Agent({
		...rest,
		memory,
