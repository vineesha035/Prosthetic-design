...
var symbol$2 = Symbol.for(marker);
var _a$2;
var _b$2;
...
function mapGatewayWarnings(warnings) {
	return (warnings != null ? warnings : []).map((warning) => warning.type === "deprecated" ? {
		type: "other",
...
var exaSearchToolFactory = createProviderToolFactoryWithOutputSchema({
	...
	outputSchema: lazySchema(() => zodSchema(z$1.union([z$1.object({
		...
		costDollars: z$1.object({
			...
			search: z$1.record(z$1.number()).optional()
		}).optional()
	}), z$1.object({
		error: z$1.enum([
			"api_error",
...
//#endregion
export { safeValidateTypes as A, isAbortError as C, resolve as D, readResponseWithSizeLimit as E, withUserAgentSuffix as M, zodSchema as N, retryWithExponentialBackoff as O, getRuntimeEnvironmentUserAgent as S, lazySchema as T, createIdGenerator as _, AISDKError as a, getErrorMessage as b, DelayedPromise as c, TypeValidationError as d, UnsupportedFunctionalityError as f, convertUint8ArrayToBase64 as g, convertBase64ToUint8Array as h, gateway as i, validateTypes as j, safeParseJSON as k, DownloadError as l, cancelResponseBody as m, GatewayError as n, APICallError as o, asSchema as p, createGatewayProvider as r, DEFAULT_MAX_DOWNLOAD_SIZE as s, GatewayAuthenticationError as t, InvalidPromptError as u, executeTool as v, isUrlSupported as w, getErrorMessage$1 as x, fetchWithValidatedRedirects as y };

//# sourceMappingURL=dist-3jq9sPhA-D2aMCPTa.js.map