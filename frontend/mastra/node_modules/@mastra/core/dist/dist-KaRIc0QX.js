...
//#endregion
//#region ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/openai-compatible/2.0.62/b7acbd067f2ec09e10301f2fe9f80cac3c408d768c9a5df1e535b692cd074fce/node_modules/@ai-sdk/openai-compatible/dist/index.mjs
...
var openaiCompatibleLanguageModelChatOptions = z.object({
	/**
...
function prepareTools$2({ tools, toolChoice }) {
...
var OpenAICompatibleChatLanguageModel = class {
	...
	async getArgs({ prompt, maxOutputTokens, temperature, topP, topK, frequencyPenalty, presencePenalty, providerOptions, stopSequences, responseFormat, seed, toolChoice, tools }) {
		...
		const { tools: openaiTools, toolChoice: openaiToolChoice, toolWarnings } = prepareTools$2({
			tools,
			toolChoice
		});
		return {
		...
		return {
			stream: response.pipeThrough(new TransformStream({
							...
							if (toolCalls[index] == null) {
								if (toolCallDelta.index != null) {
									...
									if (pending == null) {
										...
										if (pending.thoughtSignature == null && ((_i = (_h = toolCallDelta.extra_content) == null ? void 0 : _h.google) == null ? void 0 : _i.thought_signature) != null) pending.thoughtSignature = toolCallDelta.extra_content.google.thought_signature;
									}
									...
									if (((_l = toolCallDelta.function) == null ? void 0 : _l.name) == null) throw new InvalidResponseDataError({
										data: toolCallDelta,
				...
				flush(controller) {
					...
					for (const [index, pending] of pendingToolCalls) throw new InvalidResponseDataError({
						data: {
							index,
							id: pending.id,
...
var openaiCompatibleTokenUsageSchema = z.looseObject({
...
var OpenAICompatibleChatResponseSchema = z.looseObject({
	id: z.string().nullish(),
	...
	choices: z.array(z.object({
		message: z.object({
			...
			tool_calls: z.array(z.object({
				...
				extra_content: z.object({ google: z.object({ thought_signature: z.string().nullish() }).nullish() }).nullish()
			})).nullish()
		}),
...
var chunkBaseSchema = z.looseObject({
	id: z.string().nullish(),
	created: z.number().nullish(),
	model: z.string().nullish(),
	choices: z.array(z.object({
...
var createOpenAICompatibleChatChunkSchema = (errorSchema) => z.union([chunkBaseSchema, errorSchema]);
...
function getResponseMetadata2$1({ id, model, created }) {
	return {
		id: id != null ? id : void 0,
		modelId: model != null ? model : void 0,
		timestamp: created != null ? /* @__PURE__ */ new Date(created * 1e3) : void 0
...
var openaiCompatibleLanguageModelCompletionOptions = z.object({
	/**
...
var openaiCompatibleEmbeddingModelOptions = z.object({
	/**
		...
		if (files != null && files.length > 0) {
			const { value: response2, responseHeaders: responseHeaders2 } = await postFormDataToApi({
				...
				formData: convertToFormData({
					model: this.modelId,
					prompt,
					image: await Promise.all(files.map((file) => fileToBlob$1(file))),
					mask: mask != null ? await fileToBlob$1(mask) : void 0,
					n,
					size,
					...args
				}),
...
function createOpenAICompatible(options) {
	...
	const getHeaders = () => withUserAgentSuffix(headers, `ai-sdk/openai-compatible/${VERSION$3}`);
...
//#endregion
//#region ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/openai/3.0.88/3d5b955511aa68a7bfdd4e943259bc5526f882ed0b408ef9ec049ba36670be10/node_modules/@ai-sdk/openai/dist/index.mjs
...
async function throwIfOpenAIStreamErrorBeforeOutput({ stream, getError, isOutputChunk, url, requestBodyValues, responseHeaders }) {
...
var openaiChatResponseSchema = lazySchema(() => zodSchema(z.object({
	id: z.string().nullish(),
	created: z.number().nullish(),
	model: z.string().nullish(),
	choices: z.array(z.object({
...
var openaiChatChunkSchema = lazySchema(() => zodSchema(z.union([z.object({
	id: z.string().nullish(),
	created: z.number().nullish(),
	model: z.string().nullish(),
	choices: z.array(z.object({
...
var openaiLanguageModelChatOptions = lazySchema(() => zodSchema(z.object({
	/**
	* Modify the likelihood of specified tokens appearing in the completion.
	*
	* Accepts a JSON object that maps tokens (specified by their token ID in
			...
			stream: checkedResponse.pipeThrough(new TransformStream({
				...
				transform(chunk, controller) {
					...
					if (delta.tool_calls != null) for (const toolCallDelta of delta.tool_calls) {
						...
						const toolCall = toolCalls[index];
						if (toolCall.hasFinished) continue;
						if (((_j = toolCallDelta.function) == null ? void 0 : _j.arguments) != null) toolCall.function.arguments += (_l = (_k = toolCallDelta.function) == null ? void 0 : _k.arguments) != null ? _l : "";
						controller.enqueue({
							type: "tool-input-delta",
							id: toolCall.id,
...
var openaiCompletionResponseSchema = lazySchema(() => zodSchema(z.object({
	id: z.string().nullish(),
	created: z.number().nullish(),
	model: z.string().nullish(),
	choices: z.array(z.object({
...
var openaiCompletionChunkSchema = lazySchema(() => zodSchema(z.union([z.object({
	id: z.string().nullish(),
	created: z.number().nullish(),
	model: z.string().nullish(),
	choices: z.array(z.object({
...
var openaiLanguageModelCompletionOptions = lazySchema(() => zodSchema(z.object({
	/**
	* Echo back the prompt in addition to the completion.
	*/
	echo: z.boolean().optional(),
...
var openaiEmbeddingModelOptions = lazySchema(() => zodSchema(z.object({
	/**
	* The number of dimensions the resulting output embeddings should have.
	* Only supported in text-embedding-3 and later models.
	*/
...
var openaiTextEmbeddingResponseSchema = lazySchema(() => zodSchema(z.object({
	data: z.array(z.object({ embedding: z.array(z.number()) })),
	usage: z.object({ prompt_tokens: z.number() }).nullish()
})));
...
var openaiImageResponseSchema = lazySchema(() => zodSchema(z.object({
	created: z.number().nullish(),
...
var applyPatchInputSchema = lazySchema(() => zodSchema(z.object({
	callId: z.string(),
...
var applyPatchOutputSchema = lazySchema(() => zodSchema(z.object({
...
var customArgsSchema = lazySchema(() => zodSchema(z.object({
	name: z.string(),
	...
	format: z.union([z.object({
		...
		definition: z.string()
	}), z.object({ type: z.literal("text") })]).optional()
})));
var customToolFactory = createProviderToolFactory({
	id: "openai.custom",
	inputSchema: lazySchema(() => zodSchema(z.string()))
});
...
var shellInputSchema = lazySchema(() => zodSchema(z.object({ action: z.object({
	commands: z.array(z.string()),
	timeoutMs: z.number().optional(),
	maxOutputLength: z.number().optional()
}) })));
var shellOutputSchema = lazySchema(() => zodSchema(z.object({ output: z.array(z.object({
	stdout: z.string(),
	stderr: z.string(),
	outcome: z.discriminatedUnion("type", [z.object({ type: z.literal("timeout") }), z.object({
		type: z.literal("exit"),
		exitCode: z.number()
	})])
})) })));
var shellSkillsSchema = z.array(z.discriminatedUnion("type", [z.object({
...
var shellArgsSchema = lazySchema(() => zodSchema(z.object({ environment: z.union([
	z.object({
		...
		networkPolicy: z.discriminatedUnion("type", [z.object({ type: z.literal("disabled") }), z.object({
			type: z.literal("allowlist"),
			allowedDomains: z.array(z.string()),
			domainSecrets: z.array(z.object({
				domain: z.string(),
				name: z.string(),
				value: z.string()
			})).optional()
...
var toolSearchArgsSchema = lazySchema(() => zodSchema(z.object({
	execution: z.enum(["server", "client"]).optional(),
	description: z.string().optional(),
	parameters: z.record(z.string(), z.unknown()).optional()
})));
var toolSearchInputSchema = lazySchema(() => zodSchema(z.object({
	arguments: z.unknown().optional(),
	call_id: z.string().nullish()
})));
var toolSearchOutputSchema = lazySchema(() => zodSchema(z.object({ tools: z.array(z.record(z.string(), z.unknown())) })));
...
var mcpArgsSchema = lazySchema(() => zodSchema(z.object({
	serverLabel: z.string(),
	allowedTools: z.union([z.array(z.string()), z.object({
	...
	requireApproval: z.union([z.enum(["always", "never"]), z.object({ never: z.object({ toolNames: z.array(z.string()).optional() }).optional() })]).optional(),
		...
		case "tool":
			for (const part of content) {
				...
				if (output.type === "execution-denied") {
					if ((_x = (_w = output.providerOptions) == null ? void 0 : _w.openai) == null ? void 0 : _x.approvalId) continue;
				}
				const resolvedToolName = toolNameMapping.toProviderToolName(part.toolName);
...
var jsonValueSchema2 = z.lazy(() => z.union([
	z.string(),
	z.number(),
	z.boolean(),
	z.null(),
...
var openaiResponsesNestedErrorChunkSchema = z.object({
...
var openaiResponsesErrorChunkSchema = z.object({
	type: z.literal("error"),
	sequence_number: z.number(),
	code: z.string().nullish(),
	message: z.string(),
...
var openaiResponsesChunkSchema = lazySchema(() => zodSchema(z.union([
	z.object({
	...
	z.object({
		...
		item: z.discriminatedUnion("type", [
			...
			z.object({
				...
				action: z.object({ commands: z.array(z.string()) })
			}),
			z.object({
...
var openaiResponsesResponseSchema = lazySchema(() => zodSchema(z.object({
...
var openaiLanguageModelResponsesOptionsSchema = lazySchema(() => zodSchema(z.object({
	/**
...
var OpenAIResponsesLanguageModel = class {
	...
	async getArgs({ maxOutputTokens, temperature, stopSequences, topP, topK, presencePenalty, frequencyPenalty, seed, prompt, providerOptions, tools, toolChoice, responseFormat }) {
		...
		const baseArgs = {
			...
			...isReasoningModel && ((openaiOptions == null ? void 0 : openaiOptions.reasoningEffort) != null || (openaiOptions == null ? void 0 : openaiOptions.reasoningSummary) != null || (openaiOptions == null ? void 0 : openaiOptions.reasoningMode) != null || (openaiOptions == null ? void 0 : openaiOptions.reasoningContext) != null) && { reasoning: {
			...
			stream: checkedResponse.pipeThrough(new TransformStream({
				...
				transform(chunk, controller) {
					...
					if (isResponseOutputItemAddedChunk(value)) {
						...
						if (((_y = value.response.reasoning) == null ? void 0 : _y.context) != null) reasoningContext = value.response.reasoning.context;
						...
						if (((_B = value.response.reasoning) == null ? void 0 : _B.context) != null) reasoningContext = value.response.reasoning.context;
						...
						if (value.annotation.type === "url_citation") controller.enqueue({
							type: "source",
							sourceType: "url",
							id: (_E = (_D = (_C = self.config).generateId) == null ? void 0 : _D.call(_C)) != null ? _E : generateId(),
							...
							type: "source",
							sourceType: "document",
							id: (_K = (_J = (_I = self.config).generateId) == null ? void 0 : _J.call(_I)) != null ? _K : generateId(),
							mediaType: "text/plain",
							title: value.annotation.filename,
							filename: value.annotation.filename,
							providerMetadata: { [providerOptionsName]: {
							...
							type: "source",
							sourceType: "document",
							id: (_N = (_M = (_L = self.config).generateId) == null ? void 0 : _M.call(_L)) != null ? _N : generateId(),
							mediaType: "application/octet-stream",
...
var openaiSpeechModelOptionsSchema = lazySchema(() => zodSchema(z.object({
	instructions: z.string().nullish(),
...
var openaiTranscriptionResponseSchema = lazySchema(() => zodSchema(z.object({
	text: z.string(),
...
var openAITranscriptionModelOptions = lazySchema(() => zodSchema(z.object({
	/**
...
createOpenAI();
//#endregion
//#region src/llm/model/gateways/base.ts
/** @internal Stream transport handle attached by gateways that own custom streaming transports. */
const MASTRA_GATEWAY_STREAM_TRANSPORT = Symbol.for("@mastra/core.gatewayStreamTransport");
...
//#endregion
//#region ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/anthropic/3.0.103/88805d842ca0284fbaadef0ee46b0a71923da63cbf182540cfbfa25aaaf87106/node_modules/@ai-sdk/anthropic/dist/index.mjs
var VERSION$1 = "3.0.103";
...
var anthropicSystemMessageProviderOptions = z.object({ 
/**
...
*/
toolChanges: z.array(z.discriminatedUnion("type", [z.object({
...
userId: z.string().optional() }).optional(),
	...
	*/
	fallbacks: z.union([z.literal("default"), z.array(z.object({
		model: z.string(),
...
async function prepareTools$1({ tools, toolChoice, disableParallelToolUse, cacheControlValidator, supportsStructuredOutput, supportsStrictTools, defaultEagerInputStreaming = false }) {
	var _a, _b;
	tools = (tools == null ? void 0 : tools.length) ? tools : void 0;
	const toolWarnings = [];
...
function convertAnthropicMessagesUsage({ usage, rawUsage }) {
	...
	let inputTokens;
	let outputTokens;
	const servedByFallback = (_e = usage.iterations) == null ? void 0 : _e.some((iter) => iter.type === "fallback_message");
		...
		switch (type) {
			case "system": {
				...
				for (const { content: text, providerOptions } of block.messages) {
					...
					if (text !== "" || toolChanges.length === 0) content.push({
						type: "text",
						text,
				...
				if (i === 0 || system == null && toolChangeCount === 0) {
					if (toolChangeCount > 0) warnings.push({
						type: "other",
					...
					system = content.filter((part) => part.type === "text");
				} else {
					messages.push({
						role: "system",
						content
					...
					if (toolChangeCount > 0) betas.add("mid-conversation-tool-changes-2026-07-01");
				}
				break;
			}
			case "user": {
						...
						switch (part.type) {
							case "text": {
								...
								if ((textMetadata == null ? void 0 : textMetadata.type) === "compaction") anthropicContent.push({
									...
									...(textMetadata == null ? void 0 : textMetadata.citations) != null && { citations: textMetadata.citations },
									cache_control: cacheControl
								});
								break;
							}
							...
							case "tool-result": {
								...
								if (mcpToolUseIds.has(part.toolCallId)) {
									...
									if (output.type === "error-text" || output.type === "error-json") {
										let errorInfo = {};
										try {
											if (typeof output.value === "string") errorInfo = secureJsonParse(output.value);
			...
			default: throw new Error(`content type: ${type}`);
		}
	}
	return {
		prompt: {
...
function moveToolUseBlocksToEnd(content) {
	...
	for (const part of content) if (part.type === "thinking" || part.type === "redacted_thinking") {
		flushSegment();
		result.push(part);
...
var AnthropicMessagesLanguageModel = class {
	...
	*/
	...
	async getArgs({ userSuppliedBetas, prompt, maxOutputTokens, temperature, topP, topK, frequencyPenalty, presencePenalty, stopSequences, responseFormat, seed, tools, toolChoice, providerOptions, stream }) {
		...
		const { maxOutputTokens: maxOutputTokensForModel, supportsStructuredOutput: modelSupportsStructuredOutput, rejectsSamplingParameters, rejectsThinkingDisabledAboveHighEffort, isKnownModel } = getModelCapabilities(this.modelId);
		if (!isKnownModel && maxOutputTokens == null) warnings.push({
			type: "compatibility",
		...
		if (jsonResponseTool != null && (anthropicOptions == null ? void 0 : anthropicOptions.disableParallelToolUse) === false) warnings.push({
			type: "unsupported",
		...
		const baseArgs = {
			...
			...(anthropicOptions == null ? void 0 : anthropicOptions.fallbacks) != null && (anthropicOptions.fallbacks === "default" || anthropicOptions.fallbacks.length > 0) && { fallbacks: anthropicOptions.fallbacks },
			...(anthropicOptions == null ? void 0 : anthropicOptions.cacheControl) && { cache_control: anthropicOptions.cacheControl },
			...((_i = anthropicOptions == null ? void 0 : anthropicOptions.metadata) == null ? void 0 : _i.userId) != null && { metadata: { user_id: anthropicOptions.metadata.userId } },
		...
		if ((anthropicOptions == null ? void 0 : anthropicOptions.fallbacks) === "default") betas.add("server-side-fallback-2026-07-01");
		else if ((anthropicOptions == null ? void 0 : anthropicOptions.fallbacks) && anthropicOptions.fallbacks.length > 0) betas.add("server-side-fallback-2026-06-01");
		const defaultEagerInputStreaming = stream && ((_j = anthropicOptions == null ? void 0 : anthropicOptions.toolStreaming) != null ? _j : true);
		const { tools: anthropicTools2, toolChoice: anthropicToolChoice, toolWarnings, betas: toolsBetas } = await prepareTools$1(jsonResponseTool != null ? {
		...
		for (const part of response.content) switch (part.type) {
			case "text":
				if (!usesJsonResponseTool) {
					const webSearchCitations = (_a = part.citations) == null ? void 0 : _a.filter((citation) => citation.type === "web_search_result_location");
					content.push({
						type: "text",
						text: part.text,
						...webSearchCitations != null && webSearchCitations.length > 0 && { providerMetadata: { anthropic: { citations: webSearchCitations } } }
					});
			...
			case "server_tool_use":
				if (part.name === "text_editor_code_execution" || part.name === "bash_code_execution") content.push({
					...
					providerExecuted: true,
					...markCodeExecutionDynamic && true ? { dynamic: true } : {}
				});
			...
			case "web_search_tool_result":
				if (Array.isArray(part.content)) {
					...
					for (const result of part.content) content.push({
						...
						url: result.url,
						title: result.title,
						providerMetadata: { anthropic: { pageAge: (_c = result.page_age) != null ? _c : null } }
					});
				} else content.push({
					type: "tool-result",
					toolCallId: part.tool_use_id,
			...
			transform(chunk, controller) {
				...
				switch (value.type) {
							...
							switch (contentBlock.type) {
								case "text":
									controller.enqueue({
										type: "text-end",
										id: String(value.index),
										...contentBlock.citations.length > 0 && { providerMetadata: { anthropic: { citations: contentBlock.citations } } }
									});
									break;
								case "reasoning":
									controller.enqueue({
						...
						switch (deltaType) {
							...
							case "input_json_delta": {
								...
								if (isJsonResponseFromTool) {
									...
									if (contentBlock.firstDelta && contentBlock.providerToolInputType != null) delta = `{"type": "${contentBlock.providerToolInputType}",${delta.substring(1)}`;
									controller.enqueue({
										type: "tool-input-delta",
										id: contentBlock.toolCallId,
										delta
							...
							case "citations_delta": {
								...
								const contentBlock = contentBlocks[value.index];
								if ((contentBlock == null ? void 0 : contentBlock.type) === "text" && citation.type === "web_search_result_location") contentBlock.citations.push(citation);
					...
					case "message_delta":
						...
						if (value.usage.output_tokens_details != null) usage.output_tokens_details = value.usage.output_tokens_details;
...
function getModelCapabilities(modelId) {
	if (modelId.includes("claude-opus-5")) return {
	...
	else if (modelId.includes("claude-opus-4-8") || modelId.includes("claude-opus-4-7") || modelId.includes("claude-fable-5") || modelId.includes("claude-sonnet-5")) return {
		maxOutputTokens: 128e3,
		supportsStructuredOutput: true,
		rejectsSamplingParameters: true,
	...
	else if (/claude-(?:instant(?:-|$)|v?2(?=$|[-.:])|3(?=$|[-.]))/.test(modelId)) return {
		maxOutputTokens: 4096,
		supportsStructuredOutput: false,
		rejectsSamplingParameters: false,
		rejectsThinkingDisabledAboveHighEffort: false,
	...
	else if (modelId.includes("claude-")) return {
		maxOutputTokens: 128e3,
		supportsStructuredOutput: true,
		rejectsSamplingParameters: true,
		rejectsThinkingDisabledAboveHighEffort: true,
...
function createAnthropic(options = {}) {
	var _a, _b;
	const baseURL = (_a = normalizeBaseURL(loadOptionalSetting({
		settingValue: options.baseURL,
	...
	const getHeaders = () => {
		return withUserAgentSuffix({
			...
			...options.authToken ? { Authorization: `Bearer ${options.authToken}` } : { "x-api-key": loadApiKey({
				apiKey: options.apiKey,
...
createAnthropic();
//#endregion
//#region src/llm/model/gateways/constants.ts
const MASTRA_USER_AGENT = `mastra/1.57.0`;
const PROVIDERS_WITH_INSTALLED_PACKAGES = [
	"anthropic",
	"cerebras",
	"deepinfra",
	"deepseek",
...
//#endregion
//#region ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/google/3.0.101/5ca337e1534fcee1d9ea7bc8f4b8cdc64d6879c9d864a0a3259940611b7e50ee/node_modules/@ai-sdk/google/dist/index.mjs
var VERSION = "3.0.101";
var googleFailedResponseHandler = createJsonErrorResponseHandler({
	errorSchema: lazySchema(() => zodSchema(z.object({ error: z.object({
...
var googleEmbeddingContentPartSchema = z.union([
	...
	z.object({ fileData: z.object({
		fileUri: z.string(),
		mimeType: z.string()
	}) })
]);
var googleEmbeddingModelOptions = lazySchema(() => zodSchema(z.object({
	/**
...
var googleGenerativeAITextEmbeddingResponseSchema = lazySchema(() => zodSchema(z.object({ embeddings: z.array(z.object({ values: z.array(z.number()) })) })));
var googleGenerativeAISingleEmbeddingResponseSchema = lazySchema(() => zodSchema(z.object({ embedding: z.object({ values: z.array(z.number()) }) })));
	...
	for (const { role, content } of prompt) switch (role) {
		...
		case "tool": {
			...
			for (const part of content) {
				...
				const output = part.output;
				if (output.type === "content") if (supportsFunctionResponseParts) appendToolResultParts(parts, part.toolName, output.value, part.toolCallId, includeFunctionCallIds);
...
var googleLanguageModelOptions = lazySchema(() => zodSchema(z.object({
	...
	*/
	retrievalConfig: z.object({ latLng: z.object({
		latitude: z.number(),
		longitude: z.number()
	}).optional() }).optional(),
	/**
...
var getContentSchema = () => z.object({ parts: z.array(z.union([
	z.object({
...
var tokenDetailsSchema = z.array(z.object({
	modality: z.string(),
	tokenCount: z.number()
})).nullish();
...
var getUrlContextMetadataSchema = () => z.object({ urlMetadata: z.array(z.object({
	retrievedUrl: z.string(),
	urlRetrievalStatus: z.string()
})).nullish() });
var responseSchema = lazySchema(() => zodSchema(z.object({
...
var fileSearchArgsBaseSchema = z.object({
	...
	*/
	fileSearchStoreNames: z.array(z.string()).describe("The names of the file_search_stores to retrieve from. Example: `fileSearchStores/my-file-search-store-123`"),
	...
	*/
	metadataFilter: z.string().describe("Metadata filter to apply to the file search retrieval documents. See https://google.aip.dev/160 for the syntax of the filter expression.").optional()
}).passthrough();
...
var googleImageResponseSchema = lazySchema(() => zodSchema(z.object({ predictions: z.array(z.object({ bytesBase64Encoded: z.string() })).default([]) })));
var googleImageModelOptionsSchema = lazySchema(() => zodSchema(z.object({
	personGeneration: z.enum([
		"dont_allow",
		"allow_adult",
		"allow_all"
...
function convertProviderReferenceImage(refImg) {
	if (refImg.bytesBase64Encoded) return { image: {
		bytesBase64Encoded: refImg.bytesBase64Encoded,
		mimeType: "image/png"
	} };
	if (refImg.gcsUri) return { image: {
...
var googleOperationSchema = z.object({
	...
	response: z.object({ generateVideoResponse: z.object({ generatedSamples: z.array(z.object({ video: z.object({ uri: z.string().nullish() }).nullish() })).nullish() }).nullish() }).nullish()
});
var googleVideoModelOptionsSchema = lazySchema(() => zodSchema(z.object({
...
var stepSchema = () => {
	...
	const modelOutputStep = z.object({
		type: z.literal("model_output"),
		content: z.array(contentBlockSchema()).nullish()
	}).loose();
	const functionCallStep = z.object({
		type: z.literal("function_call"),
		id: z.string(),
		name: z.string(),
	...
	const builtinToolCallStep = z.object({
	...
	const builtinToolResultStep = z.object({
...
var googleInteractionsResponseSchema = lazySchema(() => zodSchema(z.object({
	id: z.string().nullish(),
...
var googleInteractionsEventSchema = lazySchema(() => zodSchema((() => {
	...
	const interactionCreatedEvent = z.object({
	...
	const stepDeltaVideo = z.object({
		type: z.literal("video"),
		data: z.string().nullish(),
		mime_type: z.string().nullish(),
		uri: z.string().nullish()
	}).loose();
	const stepDeltaBuiltinToolCall = z.object({
		type: z.enum(BUILTIN_TOOL_CALL_STEP_TYPES),
		id: z.string().nullish(),
		arguments: z.record(z.string(), z.unknown()).nullish(),
		name: z.string().nullish(),
	...
	const stepDeltaBuiltinToolResult = z.object({
		type: z.enum(BUILTIN_TOOL_RESULT_STEP_TYPES),
		call_id: z.string().nullish(),
		result: z.unknown().nullish(),
		is_error: z.boolean().nullish(),
	...
	const stepDeltaEvent = z.object({
		event_type: z.literal("step.delta"),
		event_id: z.string().nullish(),
		index: z.number(),
		delta: stepDeltaUnion
	}).loose();
	const stepStopEvent = z.object({
	...
	const interactionInProgressEvent = z.object({
		event_type: z.literal("interaction.in_progress"),
		event_id: z.string().nullish(),
		interaction_id: z.string().nullish(),
		status: status.nullish()
	}).loose();
	const interactionRequiresActionEvent = z.object({
		event_type: z.literal("interaction.requires_action"),
		event_id: z.string().nullish(),
		interaction_id: z.string().nullish(),
		status: status.nullish()
	}).loose();
	const interactionCompletedEvent = z.object({
...
var googleInteractionsLanguageModelOptions = lazySchema(() => zodSchema(z.object({
	previousInteractionId: z.string().nullish(),
	store: z.boolean().nullish(),
	agent: z.string().nullish(),
	agentConfig: z.union([z.object({ type: z.literal("dynamic") }).loose(), z.object({
	...
	*/
	responseFormat: z.array(z.union([
		z.object({
			type: z.literal("text"),
	...
	*/
	...
	responseModalities: z.array(z.enum([
		"text",
		"image",
		"audio",
		"video",
	...
	*/
	environment: z.union([z.string(), z.object({
		...
		network: z.union([z.literal("disabled"), z.object({ allowlist: z.array(z.object({
			domain: z.string(),
			transform: z.array(z.record(z.string(), z.string())).nullish()
		})) })]).nullish()
	})]).nullish()
})));
...
//#endregion
export { UnsupportedFunctionalityError as $, extractResponseHeaders as A, postToApi as B, createJsonErrorResponseHandler as C, createStatusCodeErrorResponseHandler as D, createProviderToolFactoryWithOutputSchema as E, loadApiKey as F, withoutTrailingSlash as G, safeParseJSON as H, mediaTypeToExtension as I, AISDKError as J, zodSchema as K, parseProviderOptions as L, getFromApi as M, injectJsonInstructionIntoMessages as N, delay as O, lazySchema as P, TooManyEmbeddingValuesForCallError as Q, postFormDataToApi as R, createEventSourceResponseHandler as S, createProviderToolFactory as T, validateTypes as U, resolve as V, withUserAgentSuffix as W, InvalidResponseDataError as X, APICallError as Y, NoSuchModelError as Z, convertImageModelFileToDataUri as _, PROVIDERS_WITH_INSTALLED_PACKAGES as a, convertUint8ArrayToBase64 as b, MastraModelGateway as c, OpenAICompatibleCompletionLanguageModel as d, OpenAICompatibleEmbeddingModel as f, convertBase64ToUint8Array as g, combineHeaders as h, MASTRA_USER_AGENT as i, generateId as j, downloadBlob as k, createOpenAI as l, cancelResponseBody as m, EXCLUDED_PROVIDERS as n, createAnthropic as o, createOpenAICompatible as p, EventSourceParserStream as q, GATEWAY_AUTH_HEADER as r, MASTRA_GATEWAY_STREAM_TRANSPORT as s, createGoogleGenerativeAI as t, OpenAICompatibleChatLanguageModel as u, convertToBase64 as v, createJsonResponseHandler as w, createBinaryResponseHandler as x, convertToFormData as y, postJsonToApi as z };

//# sourceMappingURL=dist-KaRIc0QX.js.map