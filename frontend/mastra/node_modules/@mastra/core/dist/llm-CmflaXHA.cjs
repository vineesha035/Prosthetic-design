...
function parseRecordDef(def, refs) {
	...
	if (((_b2 = def.keyType) == null ? void 0 : _b2._def.typeName) === zod_v3.ZodFirstPartyTypeKind.ZodString && ((_c = def.keyType._def.checks) == null ? void 0 : _c.length)) {
...
var openaiErrorDataSchema = zod_v4.z.object({ error: zod_v4.z.object({
	message: zod_v4.z.string(),
	type: zod_v4.z.string().nullish(),
	param: zod_v4.z.any().nullish(),
	code: zod_v4.z.union([zod_v4.z.string(), zod_v4.z.number()]).nullish()
}) });
...
var openaiChatResponseSchema = lazyValidator(() => zodSchema(zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
		message: zod_v4.z.object({
			role: zod_v4.z.literal("assistant").nullish(),
			content: zod_v4.z.string().nullish(),
			tool_calls: zod_v4.z.array(zod_v4.z.object({
				id: zod_v4.z.string().nullish(),
			...
			annotations: zod_v4.z.array(zod_v4.z.object({
				type: zod_v4.z.literal("url_citation"),
				url_citation: zod_v4.z.object({
		...
		logprobs: zod_v4.z.object({ content: zod_v4.z.array(zod_v4.z.object({
			token: zod_v4.z.string(),
			logprob: zod_v4.z.number(),
			top_logprobs: zod_v4.z.array(zod_v4.z.object({
				token: zod_v4.z.string(),
				logprob: zod_v4.z.number()
			}))
		})).nullish() }).nullish(),
		finish_reason: zod_v4.z.string().nullish()
	})),
	usage: zod_v4.z.object({
		prompt_tokens: zod_v4.z.number().nullish(),
		completion_tokens: zod_v4.z.number().nullish(),
		total_tokens: zod_v4.z.number().nullish(),
		prompt_tokens_details: zod_v4.z.object({
			cached_tokens: zod_v4.z.number().nullish(),
			cache_write_tokens: zod_v4.z.number().nullish()
		}).nullish(),
		completion_tokens_details: zod_v4.z.object({
			reasoning_tokens: zod_v4.z.number().nullish(),
			accepted_prediction_tokens: zod_v4.z.number().nullish(),
			rejected_prediction_tokens: zod_v4.z.number().nullish()
		}).nullish()
	}).nullish()
})));
var openaiChatChunkSchema = lazyValidator(() => zodSchema(zod_v4.z.union([zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
		delta: zod_v4.z.object({
			role: zod_v4.z.enum(["assistant"]).nullish(),
			content: zod_v4.z.string().nullish(),
			tool_calls: zod_v4.z.array(zod_v4.z.object({
				index: zod_v4.z.number(),
				id: zod_v4.z.string().nullish(),
				type: zod_v4.z.literal("function").nullish(),
				function: zod_v4.z.object({
					name: zod_v4.z.string().nullish(),
					arguments: zod_v4.z.string().nullish()
				})
			})).nullish(),
			annotations: zod_v4.z.array(zod_v4.z.object({
				type: zod_v4.z.literal("url_citation"),
...
var openaiChatLanguageModelOptions = lazyValidator(() => zodSchema(zod_v4.z.object({
	/**
	...
	*/
	logitBias: zod_v4.z.record(zod_v4.z.coerce.number(), zod_v4.z.number()).optional(),
	/**
	...
	*/
	logprobs: zod_v4.z.union([zod_v4.z.boolean(), zod_v4.z.number()]).optional(),
	/**
	* Whether to enable parallel function calling during tool use. Default to true.
	*/
	parallelToolCalls: zod_v4.z.boolean().optional(),
	/**
	...
	*/
	maxCompletionTokens: zod_v4.z.number().optional(),
	/**
	* Whether to enable persistence in responses API.
	*/
	store: zod_v4.z.boolean().optional(),
	/**
	* Metadata to associate with the request.
	*/
	metadata: zod_v4.z.record(zod_v4.z.string().max(64), zod_v4.z.string().max(512)).optional(),
	/**
	* Parameters for prediction mode.
	*/
	prediction: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.any()).optional(),
	/**
	* Whether to use structured outputs.
	*
	* @default true
	*/
	structuredOutputs: zod_v4.z.boolean().optional(),
	/**
	...
	* @default false
	*/
	strictJsonSchema: zod_v4.z.boolean().optional(),
	/**
	* Controls the verbosity of the model's responses.
	* Lower values will result in more concise responses, while higher values will result in more verbose responses.
	*/
	textVerbosity: zod_v4.z.enum([
		"low",
		"medium",
		"high"
	]).optional(),
	...
	*/
	promptCacheKey: zod_v4.z.string().optional(),
	/**
	...
	*/
	promptCacheOptions: zod_v4.z.object({
		mode: zod_v4.z.enum(["implicit", "explicit"]).optional(),
		ttl: zod_v4.z.literal("30m").optional()
	}).optional(),
	/**
	...
	* @default 'in_memory'
	*/
	promptCacheRetention: zod_v4.z.enum(["in_memory", "24h"]).optional(),
	/**
	...
	* information.
	*/
	safetyIdentifier: zod_v4.z.string().optional()
})));
...
var openaiCompletionResponseSchema = lazyValidator(() => zodSchema(zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
		text: zod_v4.z.string(),
		finish_reason: zod_v4.z.string(),
		logprobs: zod_v4.z.object({
			tokens: zod_v4.z.array(zod_v4.z.string()),
			token_logprobs: zod_v4.z.array(zod_v4.z.number()),
			top_logprobs: zod_v4.z.array(zod_v4.z.record(zod_v4.z.string(), zod_v4.z.number())).nullish()
		}).nullish()
	})),
	usage: zod_v4.z.object({
...
var openaiCompletionChunkSchema = lazyValidator(() => zodSchema(zod_v4.z.union([zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
...
var openaiCompletionProviderOptions = lazyValidator(() => zodSchema(zod_v4.z.object({
	/**
	Echo back the prompt in addition to the completion.
	*/
	echo: zod_v4.z.boolean().optional(),
	/**
	Modify the likelihood of specified tokens appearing in the completion.
	...
	*/
	logitBias: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.number()).optional(),
	/**
	The suffix that comes after a completion of inserted text.
	*/
	suffix: zod_v4.z.string().optional(),
	/**
	A unique identifier representing your end-user, which can help OpenAI to
...
var openaiEmbeddingProviderOptions = lazyValidator(() => zodSchema(zod_v4.z.object({
	/**
	The number of dimensions the resulting output embeddings should have.
	Only supported in text-embedding-3 and later models.
	*/
	dimensions: zod_v4.z.number().optional(),
	/**
	A unique identifier representing your end-user, which can help OpenAI to
	monitor and detect abuse. Learn more.
	*/
...
var openaiTextEmbeddingResponseSchema = lazyValidator(() => zodSchema(zod_v4.z.object({
	data: zod_v4.z.array(zod_v4.z.object({ embedding: zod_v4.z.array(zod_v4.z.number()) })),
	usage: zod_v4.z.object({ prompt_tokens: zod_v4.z.number() }).nullish()
})));
...
var openaiImageResponseSchema = lazyValidator(() => zodSchema(zod_v4.z.object({
	created: zod_v4.z.number().nullish(),
	data: zod_v4.z.array(zod_v4.z.object({
		b64_json: zod_v4.z.string(),
		revised_prompt: zod_v4.z.string().nullish()
	})),
	background: zod_v4.z.string().nullish(),
	output_format: zod_v4.z.string().nullish(),
	size: zod_v4.z.string().nullish(),
	quality: zod_v4.z.string().nullish(),
	usage: zod_v4.z.object({
		input_tokens: zod_v4.z.number().nullish(),
		output_tokens: zod_v4.z.number().nullish(),
		total_tokens: zod_v4.z.number().nullish(),
		input_tokens_details: zod_v4.z.object({
			image_tokens: zod_v4.z.number().nullish(),
			text_tokens: zod_v4.z.number().nullish()
		}).nullish()
	}).nullish()
})));
...
var baseImageModelOptionsObject = zod_v4.z.object({
	/**
	* Quality of the generated image(s).
	*
	* Valid values: `standard`, `hd`, `low`, `medium`, `high`, `auto`.
	*/
	quality: zod_v4.z.enum([
		"standard",
		"hd",
		"low",
		"medium",
	...
	*/
	outputCompression: zod_v4.z.number().int().min(0).max(100).optional(),
	/**
...
var openaiImageModelGenerationOptions = lazyValidator(() => zodSchema(baseImageModelOptionsObject.extend({
	...
	* looking images.
	*/
	style: zod_v4.z.enum(["vivid", "natural"]).optional(),
	/**
	* Content moderation level for the generated image(s). `low` applies
	* less restrictive filtering.
	*/
	moderation: zod_v4.z.enum(["auto", "low"]).optional()
})));
...
var openaiTranscriptionResponseSchema = lazyValidator(() => zodSchema(zod_v4.z.object({
	text: zod_v4.z.string(),
	language: zod_v4.z.string().nullish(),
	duration: zod_v4.z.number().nullish(),
	words: zod_v4.z.array(zod_v4.z.object({
		word: zod_v4.z.string(),
		start: zod_v4.z.number(),
		end: zod_v4.z.number()
	})).nullish(),
	segments: zod_v4.z.array(zod_v4.z.object({
		id: zod_v4.z.number(),
		seek: zod_v4.z.number(),
		start: zod_v4.z.number(),
		end: zod_v4.z.number(),
		text: zod_v4.z.string(),
		tokens: zod_v4.z.array(zod_v4.z.number()),
		temperature: zod_v4.z.number(),
		avg_logprob: zod_v4.z.number(),
		compression_ratio: zod_v4.z.number(),
		no_speech_prob: zod_v4.z.number()
	})).nullish()
})));
var openAITranscriptionProviderOptions = lazyValidator(() => zodSchema(zod_v4.z.object({
	/**
	* Additional information to include in the transcription response.
	*/
	include: zod_v4.z.array(zod_v4.z.string()).optional(),
	/**
	...
	* @default 0
	*/
	temperature: zod_v4.z.number().min(0).max(1).default(0).optional(),
	/**
	* The timestamp granularities to populate for this transcription.
	* @default ['segment']
	*/
	timestampGranularities: zod_v4.z.array(zod_v4.z.enum(["word", "segment"])).default(["segment"]).optional()
})));
var languageMap = {
	afrikaans: "af",
	arabic: "ar",
...
var openaiSpeechProviderOptionsSchema = lazyValidator(() => zodSchema(zod_v4.z.object({
	instructions: zod_v4.z.string().nullish(),
	speed: zod_v4.z.number().min(.25).max(4).default(1).nullish()
})));
...
var localShellInputSchema = lazySchema(() => zodSchema(zod_v4.z.object({ action: zod_v4.z.object({
	type: zod_v4.z.literal("exec"),
	command: zod_v4.z.array(zod_v4.z.string()),
	timeoutMs: zod_v4.z.number().optional(),
	user: zod_v4.z.string().optional(),
	workingDirectory: zod_v4.z.string().optional(),
	env: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.string()).optional()
}) })));
var localShellOutputSchema = lazySchema(() => zodSchema(zod_v4.z.object({ output: zod_v4.z.string() })));
...
var openaiResponsesReasoningProviderOptionsSchema = zod_v4.z.object({
	itemId: zod_v4.z.string().nullish(),
	reasoningEncryptedContent: zod_v4.z.string().nullish()
});
...
var openaiResponsesChunkSchema = lazyValidator(() => zodSchema(zod_v4.z.union([
	zod_v4.z.object({
		type: zod_v4.z.literal("response.output_text.delta"),
		item_id: zod_v4.z.string(),
		delta: zod_v4.z.string(),
		logprobs: zod_v4.z.array(zod_v4.z.object({
			token: zod_v4.z.string(),
			logprob: zod_v4.z.number(),
			top_logprobs: zod_v4.z.array(zod_v4.z.object({
				token: zod_v4.z.string(),
	...
	zod_v4.z.object({
		type: zod_v4.z.enum(["response.completed", "response.incomplete"]),
		response: zod_v4.z.object({
			incomplete_details: zod_v4.z.object({ reason: zod_v4.z.string() }).nullish(),
			usage: zod_v4.z.object({
				input_tokens: zod_v4.z.number(),
				input_tokens_details: zod_v4.z.object({
					cached_tokens: zod_v4.z.number().nullish(),
					cache_write_tokens: zod_v4.z.number().nullish(),
					orchestration_input_tokens: zod_v4.z.number().nullish(),
					orchestration_input_cached_tokens: zod_v4.z.number().nullish()
				}).nullish(),
				output_tokens: zod_v4.z.number(),
				output_tokens_details: zod_v4.z.object({
					reasoning_tokens: zod_v4.z.number().nullish(),
					orchestration_output_tokens: zod_v4.z.number().nullish()
				}).nullish()
			}),
			reasoning: zod_v4.z.object({ context: zod_v4.z.string().nullish() }).nullish(),
			service_tier: zod_v4.z.string().nullish()
		})
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.created"),
		response: zod_v4.z.object({
			id: zod_v4.z.string(),
			created_at: zod_v4.z.number(),
			model: zod_v4.z.string(),
			service_tier: zod_v4.z.string().nullish()
		})
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.output_item.added"),
		output_index: zod_v4.z.number(),
		item: zod_v4.z.discriminatedUnion("type", [
			zod_v4.z.object({
				type: zod_v4.z.literal("message"),
				id: zod_v4.z.string(),
				phase: zod_v4.z.enum(["commentary", "final_answer"]).nullish()
			}),
			zod_v4.z.object({
			...
			zod_v4.z.object({
				type: zod_v4.z.literal("web_search_call"),
				id: zod_v4.z.string(),
				status: zod_v4.z.string()
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("computer_call"),
				id: zod_v4.z.string(),
				status: zod_v4.z.string()
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("file_search_call"),
				id: zod_v4.z.string()
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("image_generation_call"),
				id: zod_v4.z.string()
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("code_interpreter_call"),
				id: zod_v4.z.string(),
				container_id: zod_v4.z.string(),
				code: zod_v4.z.string().nullable(),
				outputs: zod_v4.z.array(zod_v4.z.discriminatedUnion("type", [zod_v4.z.object({
					type: zod_v4.z.literal("logs"),
					logs: zod_v4.z.string()
				}), zod_v4.z.object({
	...
	zod_v4.z.object({
		...
		item: zod_v4.z.discriminatedUnion("type", [
			...
			zod_v4.z.object({
				...
				name: zod_v4.z.string(),
				arguments: zod_v4.z.string(),
				status: zod_v4.z.literal("completed")
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("code_interpreter_call"),
				id: zod_v4.z.string(),
			...
			zod_v4.z.object({
				type: zod_v4.z.literal("image_generation_call"),
				id: zod_v4.z.string(),
				result: zod_v4.z.string()
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("web_search_call"),
				id: zod_v4.z.string(),
				status: zod_v4.z.string(),
				action: zod_v4.z.discriminatedUnion("type", [
					zod_v4.z.object({
						type: zod_v4.z.literal("search"),
						query: zod_v4.z.string().nullish(),
						sources: zod_v4.z.array(zod_v4.z.discriminatedUnion("type", [zod_v4.z.object({
							type: zod_v4.z.literal("url"),
							url: zod_v4.z.string()
						}), zod_v4.z.object({
							type: zod_v4.z.literal("api"),
							name: zod_v4.z.string()
						})])).nullish()
					}),
					zod_v4.z.object({
						type: zod_v4.z.literal("open_page"),
						url: zod_v4.z.string().nullish()
					}),
					zod_v4.z.object({
						type: zod_v4.z.literal("find_in_page"),
						url: zod_v4.z.string().nullish(),
						pattern: zod_v4.z.string().nullish()
					})
				]).nullish()
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("file_search_call"),
				id: zod_v4.z.string(),
				queries: zod_v4.z.array(zod_v4.z.string()),
				results: zod_v4.z.array(zod_v4.z.object({
					attributes: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.unknown()),
					file_id: zod_v4.z.string(),
					filename: zod_v4.z.string(),
					score: zod_v4.z.number(),
					text: zod_v4.z.string()
				})).nullish()
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("local_shell_call"),
				id: zod_v4.z.string(),
				call_id: zod_v4.z.string(),
				action: zod_v4.z.object({
					type: zod_v4.z.literal("exec"),
					command: zod_v4.z.array(zod_v4.z.string()),
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.image_generation_call.partial_image"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		partial_image_b64: zod_v4.z.string()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.code_interpreter_call_code.delta"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		delta: zod_v4.z.string()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.code_interpreter_call_code.done"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
	...
	zod_v4.z.object({
		...
		annotation: zod_v4.z.discriminatedUnion("type", [zod_v4.z.object({
			...
			type: zod_v4.z.literal("file_citation"),
			file_id: zod_v4.z.string(),
			filename: zod_v4.z.string().nullish(),
			index: zod_v4.z.number().nullish(),
			start_index: zod_v4.z.number().nullish(),
			end_index: zod_v4.z.number().nullish(),
			quote: zod_v4.z.string().nullish()
		})])
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.reasoning_summary_part.added"),
		item_id: zod_v4.z.string(),
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.reasoning_summary_part.done"),
		item_id: zod_v4.z.string(),
		summary_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
	...
	zod_v4.z.object({ type: zod_v4.z.string() }).loose().transform((value) => ({
		type: "unknown_chunk",
		message: value.type
	}))
])));
var openaiResponsesResponseSchema = lazyValidator(() => zodSchema(zod_v4.z.object({
	...
	output: zod_v4.z.array(zod_v4.z.discriminatedUnion("type", [
		zod_v4.z.object({
			type: zod_v4.z.literal("message"),
			...
			content: zod_v4.z.array(zod_v4.z.object({
				...
				annotations: zod_v4.z.array(zod_v4.z.discriminatedUnion("type", [
					zod_v4.z.object({
						type: zod_v4.z.literal("url_citation"),
						start_index: zod_v4.z.number(),
						end_index: zod_v4.z.number(),
					...
					zod_v4.z.object({
						type: zod_v4.z.literal("container_file_citation"),
						container_id: zod_v4.z.string(),
						file_id: zod_v4.z.string(),
						filename: zod_v4.z.string().nullish(),
						start_index: zod_v4.z.number().nullish(),
					...
					zod_v4.z.object({
						type: zod_v4.z.literal("file_path"),
						file_id: zod_v4.z.string(),
						index: zod_v4.z.number().nullish()
					})
				]))
		...
		zod_v4.z.object({
			...
			queries: zod_v4.z.array(zod_v4.z.string()),
			results: zod_v4.z.array(zod_v4.z.object({
				attributes: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.union([
					zod_v4.z.string(),
					zod_v4.z.number(),
					zod_v4.z.boolean()
				])),
		...
		zod_v4.z.object({
			type: zod_v4.z.literal("computer_call"),
			id: zod_v4.z.string(),
			status: zod_v4.z.string().optional()
		}),
		zod_v4.z.object({
			type: zod_v4.z.literal("reasoning"),
			id: zod_v4.z.string(),
...
var openaiResponsesProviderOptionsSchema = lazyValidator(() => zodSchema(zod_v4.z.object({
	conversation: zod_v4.z.string().nullish(),
	include: zod_v4.z.array(zod_v4.z.enum([
	...
	*/
	logprobs: zod_v4.z.union([zod_v4.z.boolean(), zod_v4.z.number().min(1).max(TOP_LOGPROBS_MAX)]).optional(),
	/**
	* The maximum number of total calls to built-in tools that can be processed in a response.
	* This maximum number applies across all built-in tool calls, not per individual tool.
	* Any further attempts to call a tool by the model will be ignored.
	*/
	maxToolCalls: zod_v4.z.number().nullish(),
	metadata: zod_v4.z.any().nullish(),
	parallelToolCalls: zod_v4.z.boolean().nullish(),
	previousResponseId: zod_v4.z.string().nullish(),
	promptCacheKey: zod_v4.z.string().nullish(),
	/**
	* Prompt cache behavior for GPT-5.6 and later models.
	* `mode` controls whether OpenAI also places an implicit breakpoint.
	* `ttl` sets the minimum cache lifetime and currently only supports 30 minutes.
	...
	* @default 'in_memory'
	*/
	promptCacheRetention: zod_v4.z.enum(["in_memory", "24h"]).nullish(),
	/**
	...
	*/
	reasoningEffort: zod_v4.z.string().nullish(),
	/**
	...
	*/
	reasoningMode: zod_v4.z.enum(["standard", "pro"]).optional(),
	/**
	...
	*/
	reasoningContext: zod_v4.z.enum([
		"auto",
		"current_turn",
		"all_turns"
	]).optional(),
	reasoningSummary: zod_v4.z.string().nullish(),
	safetyIdentifier: zod_v4.z.string().nullish(),
	serviceTier: zod_v4.z.enum([
		"auto",
		"flex",
		"priority",
	...
	store: zod_v4.z.boolean().nullish(),
	strictJsonSchema: zod_v4.z.boolean().nullish(),
	textVerbosity: zod_v4.z.enum([
		"low",
		"medium",
		"high"
	]).nullish(),
	truncation: zod_v4.z.enum(["auto", "disabled"]).nullish(),
	user: zod_v4.z.string().nullish()
})));
var codeInterpreterInputSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	code: zod_v4.z.string().nullish(),
	containerId: zod_v4.z.string()
})));
var codeInterpreterOutputSchema = lazySchema(() => zodSchema(zod_v4.z.object({ outputs: zod_v4.z.array(zod_v4.z.discriminatedUnion("type", [zod_v4.z.object({
	type: zod_v4.z.literal("logs"),
	logs: zod_v4.z.string()
}), zod_v4.z.object({
	type: zod_v4.z.literal("image"),
...
var codeInterpreterArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({ container: zod_v4.z.union([zod_v4.z.string(), zod_v4.z.object({ fileIds: zod_v4.z.array(zod_v4.z.string()).optional() })]).optional() })));
...
var comparisonFilterSchema = zod_v4.z.object({
	key: zod_v4.z.string(),
	type: zod_v4.z.enum([
		"eq",
		"ne",
	...
	value: zod_v4.z.union([
		zod_v4.z.string(),
		zod_v4.z.number(),
		zod_v4.z.boolean(),
		zod_v4.z.array(zod_v4.z.string())
	])
});
var compoundFilterSchema = zod_v4.z.object({
	type: zod_v4.z.enum(["and", "or"]),
	filters: zod_v4.z.array(zod_v4.z.union([comparisonFilterSchema, zod_v4.z.lazy(() => compoundFilterSchema)]))
});
var fileSearchArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	vectorStoreIds: zod_v4.z.array(zod_v4.z.string()),
	maxNumResults: zod_v4.z.number().optional(),
	ranking: zod_v4.z.object({
		ranker: zod_v4.z.string().optional(),
		scoreThreshold: zod_v4.z.number().optional()
	}).optional(),
	filters: zod_v4.z.union([comparisonFilterSchema, compoundFilterSchema]).optional()
})));
var fileSearchOutputSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	queries: zod_v4.z.array(zod_v4.z.string()),
	results: zod_v4.z.array(zod_v4.z.object({
		attributes: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.unknown()),
		fileId: zod_v4.z.string(),
		filename: zod_v4.z.string(),
		score: zod_v4.z.number(),
		text: zod_v4.z.string()
	})).nullable()
...
var webSearchArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	externalWebAccess: zod_v4.z.boolean().optional(),
	filters: zod_v4.z.object({
		allowedDomains: zod_v4.z.array(zod_v4.z.string()).optional(),
		blockedDomains: zod_v4.z.array(zod_v4.z.string()).optional()
	}).optional(),
	searchContextSize: zod_v4.z.enum([
		"low",
		"medium",
		"high"
	]).optional(),
...
var webSearchToolFactory = createProviderDefinedToolFactoryWithOutputSchema({
	...
	name: "web_search",
	inputSchema: lazySchema(() => zodSchema(zod_v4.z.object({}))),
	outputSchema: lazySchema(() => zodSchema(zod_v4.z.object({
		action: zod_v4.z.discriminatedUnion("type", [
			zod_v4.z.object({
				type: zod_v4.z.literal("search"),
			...
			zod_v4.z.object({
				type: zod_v4.z.literal("openPage"),
				url: zod_v4.z.string().nullish()
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("findInPage"),
				url: zod_v4.z.string().nullish(),
				pattern: zod_v4.z.string().nullish()
			})
		]).optional(),
...
var webSearchPreviewArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	searchContextSize: zod_v4.z.enum([
		"low",
		"medium",
		"high"
...
var webSearchPreview = createProviderDefinedToolFactoryWithOutputSchema({
	...
	inputSchema: lazySchema(() => zodSchema(zod_v4.z.object({}))),
	outputSchema: lazySchema(() => zodSchema(zod_v4.z.object({ action: zod_v4.z.discriminatedUnion("type", [
		zod_v4.z.object({
			type: zod_v4.z.literal("search"),
			query: zod_v4.z.string().optional()
		}),
...
var imageGenerationArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	background: zod_v4.z.enum([
		"auto",
		"opaque",
		"transparent"
	]).optional(),
	inputFidelity: zod_v4.z.enum(["low", "high"]).optional(),
	inputImageMask: zod_v4.z.object({
		fileId: zod_v4.z.string().optional(),
		imageUrl: zod_v4.z.string().optional()
	}).optional(),
	model: zod_v4.z.string().optional(),
	moderation: zod_v4.z.enum(["auto"]).optional(),
	outputCompression: zod_v4.z.number().int().min(0).max(100).optional(),
	outputFormat: zod_v4.z.enum([
		"png",
		"jpeg",
	...
	partialImages: zod_v4.z.number().int().min(0).max(3).optional(),
	quality: zod_v4.z.enum([
		"auto",
		"low",
		"medium",
...
var imageGenerationToolFactory = createProviderDefinedToolFactoryWithOutputSchema({
	...
	inputSchema: lazySchema(() => zodSchema(zod_v4.z.object({}))),
	outputSchema: lazySchema(() => zodSchema(zod_v4.z.object({ result: zod_v4.z.string() })))
});
...
var tokenUsageSchema = zod_v4.z.object({
	prompt_tokens: zod_v4.z.number().nullish(),
	completion_tokens: zod_v4.z.number().nullish(),
	prompt_cache_hit_tokens: zod_v4.z.number().nullish(),
	prompt_cache_miss_tokens: zod_v4.z.number().nullish(),
	total_tokens: zod_v4.z.number().nullish(),
	completion_tokens_details: zod_v4.z.object({ reasoning_tokens: zod_v4.z.number().nullish() }).nullish()
}).nullish();
var deepSeekErrorSchema = zod_v4.z.object({ error: zod_v4.z.object({
	message: zod_v4.z.string(),
	type: zod_v4.z.string().nullish(),
	param: zod_v4.z.any().nullish(),
	code: zod_v4.z.union([zod_v4.z.string(), zod_v4.z.number()]).nullish()
}) });
var deepseekChatResponseSchema = zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
		message: zod_v4.z.object({
			role: zod_v4.z.literal("assistant").nullish(),
			content: zod_v4.z.string().nullish(),
			reasoning_content: zod_v4.z.string().nullish(),
			tool_calls: zod_v4.z.array(zod_v4.z.object({
				id: zod_v4.z.string().nullish(),
				function: zod_v4.z.object({
					name: zod_v4.z.string(),
...
var deepseekChatChunkSchema = lazySchema(() => zodSchema(zod_v4.z.union([zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
...
var deepseekChatOptions = zod_v4.z.object({
	/**
	...
	*/
	thinking: zod_v4.z.object({ type: zod_v4.z.enum([
		"adaptive",
		"enabled",
		"disabled"
	]).optional() }).optional(),
...
function createOpenAIWebSocketFetch(options) {
	...
	function getConnection(authorization, headers, signal) {
		...
		if (ws$1?.readyState === ws.default.OPEN && connectionKey === nextConnectionKey) return Promise.resolve(ws$1);
		if (ws$1?.readyState === ws.default.OPEN && connectionKey !== nextConnectionKey) {
			ws$1.close();
			ws$1 = null;
			connectionKey = null;
		}
		...
		connecting = new Promise((resolve, reject) => {
			let settled = false;
			const socket = new ws.default(getWebSocketUrl(wsUrl, apiKeyQueryParam, apiKey), { headers: {
				...normalizedHeaders,
			...
			socket.on("close", () => {
				if (ws$1 === socket) ws$1 = null;
				if (ws$1 === null) connectionKey = null;
			});
		});
		return connecting;
	}
		...
		const responseStream = new ReadableStream({
			start(controller) {
				...
				function cleanup({ closeSocket = false } = {}) {
					...
					if (closeSocket && ws$1 === connection) {
						connection.close();
						ws$1 = null;
						connectionKey = null;
					}
...
var AzureOpenAIGateway = class extends require_dist.MastraModelGateway {
	config;
	id = "azure-openai";
	name = "azure-openai";
	tokenCache = new require_inmemory.InMemoryServerCache();
	...
	validateConfig() {
		if (!this.config.resourceName) throw new require_error.MastraError({
			id: "AZURE_GATEWAY_INVALID_CONFIG",
			domain: "LLM",
			category: "UNKNOWN",
			text: "resourceName is required for Azure OpenAI gateway"
		});
		if (!this.config.apiKey && this.config.authentication?.type !== "entraId") throw new require_error.MastraError({
			id: "AZURE_GATEWAY_INVALID_CONFIG",
			domain: "LLM",
			category: "UNKNOWN",
			text: "apiKey or Entra ID authentication is required for Azure OpenAI gateway"
		});
		if (this.config.authentication?.type === "entraId" && !this.config.authentication.credential) throw new require_error.MastraError({
			id: "AZURE_GATEWAY_INVALID_CONFIG",
			domain: "LLM",
			category: "UNKNOWN",
		...
		if (this.config.useResponsesAPI && this.config.useDeploymentBasedUrls === true) throw new require_error.MastraError({
			id: "AZURE_GATEWAY_INVALID_CONFIG",
			domain: "LLM",
			category: "UNKNOWN",
		...
		if (this.config.useResponsesAPI && this.config.apiVersion && !["v1", "preview"].includes(this.config.apiVersion)) throw new require_error.MastraError({
			id: "AZURE_GATEWAY_INVALID_CONFIG",
			domain: "LLM",
			category: "UNKNOWN",
			text: "useResponsesAPI: true requires apiVersion: \"v1\" or apiVersion: \"preview\". Omit apiVersion to use \"v1\"."
		});
		if (this.config.useDeploymentBasedUrls === false && this.config.apiVersion && !["v1", "preview"].includes(this.config.apiVersion)) throw new require_error.MastraError({
			id: "AZURE_GATEWAY_INVALID_CONFIG",
			domain: "LLM",
			category: "UNKNOWN",
	...
	getManagementCredentials(management) {
		...
		if (missing.length > 0) throw new require_error.MastraError({
	...
	async getEntraIdToken() {
		if (this.config.authentication?.type !== "entraId") throw new require_error.MastraError({
	...
	async fetchEntraIdToken(scope, cacheKey) {
		...
		if (!accessToken?.token) throw new require_error.MastraError({
	...
	async resolveLanguageModel({ modelId, apiKey, headers, transport, responsesWebSocket }) {
		...
		const azureConfig = {
			...
			headers: {
				"User-Agent": require_dist.MASTRA_USER_AGENT,
				...headers
			},
		...
		if (useResponsesAPI) {
			...
			if (websocketFetch) Object.defineProperty(model, require_dist.MASTRA_GATEWAY_STREAM_TRANSPORT, {
				configurable: true,
				value: {
...
function isExpectedMissingAuthError(error) {
	if (error instanceof require_error.MastraError) return MISSING_AUTH_ERROR_IDS.has(error.id);
	if (error instanceof Error) {
...
var GatewayManager = class GatewayManager {
	...
	constructor(gateways = []) {
		...
		this.gateways = gateways.filter((gateway) => {
			if (!require_gateway_helpers.shouldEnableGateway(gateway)) return false;
			const id = require_gateway_helpers.getGatewayId(gateway);
	...
	*/
	...
	findGatewayForModel(routerId) {
		return require_gateway_helpers.findGatewayForModel(routerId, this.gateways);
	}
	/**
	...
	*/
	resolveModelId(routerId) {
		...
		const gatewayId = require_gateway_helpers.getGatewayId(gateway);
		const { providerId, modelId } = require_models_dev.parseModelRouterId(routerId, GatewayManager.getPrefixForId(gatewayId, routerId));
		return {
			gateway,
			gatewayId,
			providerId,
	...
	async listProviders() {
		...
		for (const gateway of this.gateways) try {
			...
			for (const [providerId, config] of Object.entries(gatewayProviders)) {
				...
				registry[key] = {
					...config,
					gateway: require_gateway_helpers.getGatewayId(gateway)
				};
			}
		} catch (error) {
			console.warn(`Failed to load providers from gateway ${require_gateway_helpers.getGatewayId(gateway)}:`, error);
		}
		return registry;
	}
	/**
...
var ModelRouterLanguageModel = class ModelRouterLanguageModel {
	...
	*/
	...
	stripUnsupportedSamplingParams(options) {
		if (require_provider_registry.modelSupportsTemperature(this.config.routerId) !== false) return options;
	...
	async doGenerate(options) {
		...
		return new require_model.AISDKV5LanguageModel(model).doGenerate(sanitizedOptions);
	}
	async doStream(options) {
		const resolved = this.#manager.resolveModelId(this.config.routerId);
		let auth;
		...
		const streamResult = await new require_model.AISDKV5LanguageModel(model).doStream(sanitizedOptions);
		attachModelStreamTransport(streamResult, streamTransport);
		return streamResult;
	}
	async resolveLanguageModel({ modelId, providerId, apiKey, auth, headers, transport, responsesWebSocket }) {
		...
		const key = (0, crypto.createHash)("sha256").update(JSON.stringify([
			this.gatewayId,
			modelId,
			providerId,
			this.config.url || "",
		...
		if (this.config.url) {
			const modelInstance = require_dist.createOpenAICompatible({
				name: providerId,
				apiKey,
	...
	resolveOpenAIWebSocketModel({ modelId, apiKey, baseURL, headers, responsesWebSocket }) {
		...
		return {
			modelInstance: require_dist.createOpenAI({
				apiKey,
				baseURL,
				headers,
				fetch: wsFetch
...
function readGatewayStreamTransport(model) {
	return model[require_dist.MASTRA_GATEWAY_STREAM_TRANSPORT];
}
//#endregion
...
* ```
*/
async function resolveModelConfig(modelConfig, requestContext = new require_request_context.RequestContext(), mastra) {
	if (typeof modelConfig === "function") modelConfig = await modelConfig({
		requestContext,
		mastra
	});
	if (modelConfig instanceof ModelRouterLanguageModel || modelConfig instanceof AISDKV4LegacyLanguageModel || modelConfig instanceof require_model.AISDKV5LanguageModel || modelConfig instanceof AISDKV6LanguageModel || modelConfig instanceof AISDKV7LanguageModel) return modelConfig;
	if (typeof modelConfig === "object" && "specificationVersion" in modelConfig) {
		if (modelConfig.specificationVersion === "v2") return new require_model.AISDKV5LanguageModel(modelConfig);
		...
		if (typeof modelConfig.doStream === "function" && typeof modelConfig.doGenerate === "function") return new require_model.AISDKV5LanguageModel(modelConfig);
		return modelConfig;
	}
...
var ModelRouterEmbeddingModel = class {
	...
	constructor(config) {
		...
		if (normalizedConfig.providerId === MASTRA_GATEWAY_ID) {
			...
			this.providerModel = require_dist.createOpenAICompatible({
			...
			const providerConfig = require_provider_registry.GatewayRegistry.getInstance().getProviderConfig(normalizedConfig.providerId);
			...
			if (normalizedConfig.providerId === "openai") this.providerModel = require_dist.createOpenAI({ apiKey }).embeddingModel(normalizedConfig.modelId);
			else if (normalizedConfig.providerId === "google") this.providerModel = require_dist.createGoogleGenerativeAI({ apiKey }).embeddingModel(normalizedConfig.modelId);
			else {
...
Object.defineProperty(exports, "attachModelStreamTransport", {
	enumerable: true,
	get: function() {
		return attachModelStreamTransport;
	}
});
...
Object.defineProperty(exports, "readModelStreamTransport", {
	enumerable: true,
	get: function() {
		return readModelStreamTransport;
	}
});
...
//# sourceMappingURL=llm-CmflaXHA.cjs.map