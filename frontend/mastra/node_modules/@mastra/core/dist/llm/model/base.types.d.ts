import type { UIMessage, CoreMessage, GenerateTextResult as OriginalGenerateTextResult, GenerateObjectResult as OriginalGenerateObjectResult, StreamTextResult as OriginalStreamTextResult, StreamObjectResult as OriginalStreamObjectResult, generateText, generateObject, streamText, streamObject, StreamObjectOnFinishCallback as OriginalStreamObjectOnFinishCallback, StreamTextOnFinishCallback as OriginalStreamTextOnFinishCallback, StreamTextOnStepFinishCallback as OriginalStreamTextOnStepFinishCallback, GenerateTextOnStepFinishCallback as OriginalGenerateTextOnStepFinishCallback, Tool, ToolSet, DeepPartial } from '../../_types/@internal_ai-sdk-v4/dist/index.d.ts';
...
import type { ZodSchema } from '../../schema/index.js';
import type { inferOutput, ScoringProperties, TripwireProperties } from './shared.types.js';
export type { ToolSet } from '../../_types/@internal_ai-sdk-v4/dist/index.d.ts';
...
type OverloadedParameters<T> = T extends {
    ...
    (...args: infer A1): unknown;
    (...args: infer A2): unknown;
} ? A1 | A2 : T extends (...args: infer A1) => unknown ? A1 : never;
...
export type OriginalGenerateObjectOptions<_Output extends ZodSchema | JSONSchema7 | undefined = undefined> = GenerateObjectOptionsFromSdk;
...
export type StreamObjectResult<Output extends ZodSchema | JSONSchema7> = OriginalStreamObjectResult<DeepPartial<inferOutput<Output>>, inferOutput<Output>, unknown> & TripwireProperties;
