import type { EmbeddingModel } from '../../_types/@internal_ai-sdk-v5/dist/index.d.ts';
 ...
 */
export type EmbeddingModelId = 'openai/text-embedding-3-small' | 'openai/text-embedding-3-large' | 'openai/text-embedding-ada-002' | 'google/gemini-embedding-001';
/**
