...
export declare function _resetCapabilityCaches(): void;
/**
 ...
 */
export declare function modelSupportsAttachments(modelRouterId: string): boolean | undefined;
/**
 * Check whether a model supports the `temperature` sampling parameter.
 * Returns `true` if the model is listed, `false` if the provider is known but
 * the model isn't listed, or `undefined` when no data exists for the provider.
 */
export declare function modelSupportsTemperature(modelRouterId: string): boolean | undefined;
/**
 * Check whether a model supports native structured output.
 * Returns `true` if the model is listed, `false` if the provider is known but
 * the model isn't listed, or `undefined` when no data exists for the provider.
 */
export declare function modelSupportsStructuredOutput(modelRouterId: string): boolean | undefined;
/**
