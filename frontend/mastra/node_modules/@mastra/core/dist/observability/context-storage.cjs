...
*/
const spanContextStorage = new (require("async_hooks")).AsyncLocalStorage();
/**
...
function initContextStorage() {
	...
	initialized = true;
	require_utils.setCurrentSpanResolver(getCurrentSpan);
	require_utils.setExecuteWithContext(executeWithContext);
	require_utils.setExecuteWithContextSync(executeWithContextSync);
}
/**
...
//# sourceMappingURL=context-storage.cjs.map