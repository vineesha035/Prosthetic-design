...
export interface Processor<TId extends string = string, TTripwireMetadata = unknown> {
     ...
     */
    processToolResult?(args: ProcessToolResultArgs<TTripwireMetadata>): Promise<MessageList | MastraDBMessage[] | undefined | void> | MessageList | MastraDBMessage[] | void | undefined;
    /**
