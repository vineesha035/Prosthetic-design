...
import type { PruneOptions, PruneResult, RetentionTablesDescriptor, TableRetentionPolicy } from '../../retention.js';
/**
...
export declare abstract class ThreadStateStorage extends MastraBase {
     ...
     */
    prune(_policies: Record<string, TableRetentionPolicy>, _options?: PruneOptions): Promise<PruneResult[]>;
    /**
