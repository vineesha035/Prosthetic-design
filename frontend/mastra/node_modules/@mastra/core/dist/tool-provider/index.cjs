...
function resolveCallerSuppliedAuthorId(requestContext, logger) {
	const resourceId = requestContext?.[require_request_context.MASTRA_RESOURCE_ID_KEY];
...
exports.DuplicateToolProviderError = DuplicateToolProviderError;
exports.SHARED_BUCKET_ID = SHARED_BUCKET_ID;
exports.UnknownToolProviderError = UnknownToolProviderError;
exports.buildConnectionSuffix = buildConnectionSuffix;
exports.resolveStoredToolProviders = resolveStoredToolProviders;
