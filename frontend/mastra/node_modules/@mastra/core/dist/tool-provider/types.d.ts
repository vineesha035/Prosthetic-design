 ...
 * `scope: 'shared'`.
 */
export declare const SHARED_BUCKET_ID = "shared";
/**
 ...
 */
export type ToolProviders = Record<string, ToolProviderConfig>;
/**
...
export interface ToolProvider {
     ...
     */
    resolveTools(toolSlugs: string[], toolConfigs?: Record<string, StorageToolConfig>, options?: ResolveToolProviderToolsOptions): Promise<Record<string, ToolAction<any, any, any>>>;
