...
//#region src/tools/stream.ts
var ToolStream = class extends stream_web.WritableStream {
	prefix;
	callId;
	name;
	runId;
	...
	async _write(data) {
		if (this.writeFn) await this.writeFn({
	...
	async custom(data) {
		if (this.writeFn) await this.writeFn(data);
	}
};
//#endregion
...
//# sourceMappingURL=types-CepZ83u8.cjs.map