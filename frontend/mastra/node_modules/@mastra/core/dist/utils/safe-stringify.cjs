...
*/
const SERIALIZATION_NODE_BUDGET = 1e6;
/**
...
function boundedStringify(value) {
	...
	try {
		return JSON.stringify(value, (_key, val) => {
			if (--budget < 0) throw new RangeError("boundedStringify: value exceeds the serialization node budget");
			return val;
		});
	} catch {
		return;
...
*/
function isBoundedSerializable(value) {
	return boundedStringify(value) !== void 0;
}
/**
...
*/
function collapseStringify(value) {
...
exports.isBoundedSerializable = isBoundedSerializable;
