...
import { n as StepExecutor, o as getStepEntry, t as WorkflowEventProcessor } from "./workflow-event-processor-BbED1LMn.js";
import { t as Scheduler } from "./scheduler-CY8m1fr_.js";
import { n as MastraWorker, t as PullTransport } from "./pull-transport-C-gk1xyp.js";
...
var InProcessStrategy = class {
	...
	async executeStep(params) {
		...
		const entry = getStepEntry(this.#mastra.getWorkflowById(params.workflowId), params.executionPath);
		...
		const rc = new RequestContext(Object.entries(params.requestContext ?? {}));
		let abortController;
		...
		return new StepExecutor({ mastra: this.#mastra }).execute({
...
//#endregion
export { HttpRemoteStrategy as a, OrchestrationWorker as i, BackgroundTaskWorker as n, StepExecutionError as o, SchedulerWorker as r, InProcessStrategy as t };

//# sourceMappingURL=worker-Cld7uOHj.js.map