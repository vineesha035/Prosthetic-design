 ...
 */
import type { WorkspaceToolName, WORKSPACE_TOOLS } from '../constants/index.js';
/**
 ...
 * ```
 */
export type DynamicToolConfigValue<TContext = ToolConfigContext> = boolean | ((context: TContext) => boolean | Promise<boolean>);
...
export interface WorkspaceToolHooks {
    beforeToolCall?: (context: WorkspaceToolHookContext) => void | WorkspaceToolBeforeHookResult | Promise<void | WorkspaceToolBeforeHookResult>;
...
} & Partial<Record<Exclude<WorkspaceToolName, typeof WORKSPACE_TOOLS.SANDBOX.EXECUTE_COMMAND | typeof WORKSPACE_TOOLS.FILESYSTEM.READ_FILE>, WorkspaceToolConfig>>;
