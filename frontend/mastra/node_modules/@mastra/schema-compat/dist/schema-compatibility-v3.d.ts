import { z, ZodOptional, ZodObject, ZodArray, ZodUnion, ZodString, ZodNumber, ZodDate, ZodDefault, ZodNull, ZodNullable, ZodIntersection } from 'zod/v3';
...
export declare const isNullable: (v: ZodTypeAny) => v is ZodNullable<any>;
...
export declare const isIntersection: (v: ZodTypeAny) => v is ZodIntersection<any, any>;
/**
...
export declare class SchemaCompatLayer {
     ...
     */
    defaultZodNullableHandler(value: ZodNullable<any>, handleTypes?: readonly AllZodType[]): ZodTypeAny;
    /**
     * Recursively collects leaf types from a ZodIntersection tree.
     */
    private collectIntersectionLeaves;
    /**
     ...
     */
    defaultZodIntersectionHandler(value: ZodIntersection<any, any>): ZodTypeAny;
    /**
