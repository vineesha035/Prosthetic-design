...
export type AISdkSchemaLike<Output = unknown> = {
    _type: Output;
};
export type PublicSchema<Output = unknown, Input = Output> = z4.ZodType<Output, Input> | z3.Schema<Output, z3.ZodTypeDef, Input> | SchemaV4<Output> | SchemaV5<Output> | SchemaV6<Output> | JSONSchema7 | StandardSchemaWithJSON<Input, Output> | AISdkSchemaLike<Output>;
export type InferPublicSchema<T extends PublicSchema> = T extends {
...
} ? O : T extends PublicSchema<infer Output> ? Output : never;
