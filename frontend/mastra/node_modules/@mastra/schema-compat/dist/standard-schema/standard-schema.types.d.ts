import type { StandardJSONSchemaV1, StandardSchemaV1, StandardTypedV1 } from '../_types/@standard-schema_spec/dist/index.d.ts';
/**
 ...
 */
export type StandardSchemaWithJSON<Input = unknown, Output = Input> = StandardSchemaV1<Input, Output> & StandardJSONSchemaV1<Input, Output>;
/**
 * Props type for the combined standard schema interface.
 */
export type StandardSchemaWithJSONProps<Input = unknown, Output = Input> = StandardSchemaV1.Props<Input, Output> & StandardJSONSchemaV1.Props<Input, Output>;
/**
...
//# sourceMappingURL=standard-schema.types.d.ts.map