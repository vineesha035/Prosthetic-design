 ...
 */
export type PostHogFlagsStorageFormat = Pick<PostHogFeatureFlagDetails, 'flags'> & Partial<Pick<PostHogFlagsResponse, 'requestId' | 'evaluatedAt' | 'minimalFlagCalledEvents'>> & {
    errorsWhileComputingFlags?: boolean;
    quotaLimited?: string[];
